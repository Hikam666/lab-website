...
$sql = "SELECT a.*, m.lokasi_file as foto FROM anggota_lab a LEFT JOIN media m ON a.id_foto = m.id_media WHERE a.id_anggota = $1";
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo getAdminUrl('galeri/index.php'); ?>" class="btn btn-secondary"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
    </div>
</div>
    ...
    <div class="col-lg-6">
        <div class="card border-danger">
            ...
            <div class="card-body">
                ...
                <table class="table">
                    <tr><th width="150">Nama:</th><td><strong><?php echo htmlspecialchars($anggota['nama']); ?></strong></td></tr>
                    <tr><th>Email:</th><td><?php echo htmlspecialchars($anggota['email']); ?></td></tr>
                    <?php if ($anggota['peran_lab']): ?>
                    <tr><th>Peran Lab:</th><td><?php echo htmlspecialchars($anggota['peran_lab']); ?></td></tr>
                    <?php endif; ?>
                    <tr><th>Status:</th><td><span class="badge bg-<?php echo $anggota['aktif']?'success':'secondary'; ?>"><?php echo $anggota['aktif']?'Aktif':'Non-aktif'; ?></span></td></tr>
                </table>
                ...
                <form method="POST" class="mt-4">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo getAdminUrl('galeri/index.php'); ?>" class="btn btn-secondary btn-lg"><i class="bi bi-x-circle me-2"></i>Batal</a>
                    </div>
                </form>
            </div>
        </div>
